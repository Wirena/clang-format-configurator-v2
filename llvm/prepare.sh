...
function inside-container() (
    ...
    CORE_COUNT=$(nproc)
    declare -a TAGS=("llvmorg-19.1.0" "llvmorg-18.1.8"  "llvmorg-18.1.0"  "llvmorg-17.0.6" "llvmorg-17.0.0" "llvmorg-16.0.6" "llvmorg-16.0.0" "llvmorg-15.0.7"  "llvmorg-15.0.0" "llvmorg-14.0.6"
