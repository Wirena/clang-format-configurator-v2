    ...
    render() {
        return (
            ...
            <div className="OptionList">
                <Option
                    key={this.llvmVersionOption.title}
                    option={this.llvmVersionOption}
                    selected={{ Version: this.state.selectedVersion }}
                    onChange={({ newValue } = {}) => {
                ...
                <Option
                    ...
                    selected={
                        this.state.chosenOptions.BasedOnStyle
                    }
                    onChange={({ newValue } = {}) => {
                        ...
                        sourceOptionList[this.state.selectedVersion]
                            ...
                            .forEach((option) => {
                                if (
                                    ...
                                    option.values[0].defaults[newValue] !==
                                        undefined
                                ) {
                                    st.chosenOptions[option.title] =
                                        option.values[0]["defaults"][
                                            newValue
                                        ].value;
                                } else {
